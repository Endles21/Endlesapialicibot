...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Endlesapialicibot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Endlesapialicibot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Endlesapialicibot")
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using https://telegram.dog/Endlesapialicibot")
    #
